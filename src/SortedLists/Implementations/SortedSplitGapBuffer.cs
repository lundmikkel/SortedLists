namespace SortedLists
{
    ...
    public class SortedSplitGapBuffer<T> : ISortedList<T>
        where T : IComparable<T>
    {
        #region Fields

        private readonly GapBuffer<GapBuffer<T>> _lists;
        ...
        public SortedSplitGapBuffer(int deepness = 512)
        {
            ...
            _deepness = deepness;
            _lists = new GapBuffer<GapBuffer<T>> { new GapBuffer<T>() };
        ...
        public bool Add(T item)
        {
            ...
            else if (itemIndex == list.Count && listIndex == _lists.Count - 1)
            {
                ...
                _lists.Add(new GapBuffer<T> { item });
            ...
            else
            {
                ...
                if (listIndex == _lists.Count - 1 || mid <= _lists[listIndex + 1].Count)
                {
                    ...
                    _lists.Insert(listIndex + 1, new GapBuffer<T>(mid));
                ...
                _lists[listIndex + 1].InsertRange(0, list, mid, mid);
